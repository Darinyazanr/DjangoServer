...
configDic=json.load(codecs.open('./CONFIG.txt', 'r', encoding='utf-8'))

model=predict_online.loadModel(configDic['model'])
...
def dignos_predict(request):
    ...
    if request.method == 'POST':
        ...
        try:
            dic=predict_online.disease_online(body,model,transformPk,normalPk)
