...
#共同路径
PATH='/home/jq/quanKe_Version1.0'
...
def normalized_symptomName(symptom_name):
    synonym_table = PATH + '/synonyms/symptomSynonym.txt'
...
def normalized_diseaseName(disease_name):
    BJCYYY_name2code_path = PATH+'/synonyms/BJCYYY_name2code.txt'
    BJCYYY_name2code_dic = json.load(codecs.open(BJCYYY_name2code_path, 'r', encoding='utf-8'))
    if disease_name in BJCYYY_name2code_dic:
        return disease_name
    else:
        BJCYYY_name2code_old_path= PATH+'/synonyms/BJCYYY_name2code_old.txt'
